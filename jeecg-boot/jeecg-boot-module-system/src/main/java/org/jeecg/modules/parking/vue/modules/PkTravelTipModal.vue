  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="阅读量" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['count']" placeholder="请输入阅读量" style="width: 100%"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/org.jeecg.modules.parking/pkTravelTip/add",
          edit: "/org.jeecg.modules.parking/pkTravelTip/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'title','type','author','thumbnail','content','count','remarks'))
      },
