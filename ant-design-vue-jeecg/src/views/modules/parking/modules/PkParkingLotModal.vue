    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="价格" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['prices']" placeholder="请输入价格"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','totalLot','freeLot','tips','tipTags','payTags','type','longitude','latitude','score','images','payCode','prices','address','ext1','ext2','ext3','ext4','remarks'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','totalLot','freeLot','tips','tipTags','payTags','type','longitude','latitude','score','images','payCode','prices','address','ext1','ext2','ext3','ext4','remarks'))
      },
