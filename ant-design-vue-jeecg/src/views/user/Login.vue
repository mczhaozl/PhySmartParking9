  ...
  <div class="main">
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      <a-tabs
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
         ...
         <!-- <a-row :gutter="0">
           ...
           &lt;!&ndash; <a-col :span="8" style="text-align: right">
      ...
      <a-form-item>
        ...
        <router-link v-if="!isMobile()" :to="{ name: 'alteration'}" class="forge-password" style="float: right;">
          忘记密码
        </router-link>
       <router-link v-if="!isMobile()" :to="{ name: 'register'}" class="forge-password" style="float: right;margin-right: 10px" >
          注册账户
        </router-link>
      </a-form-item>
